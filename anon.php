...
$data = json_decode(file_get_contents("anondata100565.json"), true);
...
if ($_GET['token'] == "6254609328:AAGTbEZL9zM1w3VDg6JIPyHlGklqGk0Ue2k") {
...
if ($text == "/stopsearch") {
    if (!isset($data["matched"][$chat_id])) {
        if (isset($data["searching"])) {
            ...
            file_put_contents("anondata100565.json", json_encode($data));
